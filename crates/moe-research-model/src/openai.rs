...
use moe_research_net::{NetworkClient, NetworkRequest, SseEvent, SseNetworkStream};
...
/// parser, mirroring the tolerant strategy in `moe-research-search`'s Grok adapter.
/// This keeps MoeResearch robust against provider additions without requiring a
/// client-side update.
#[derive(Deserialize)]
...
enum OpenAiResponseOutput {
    ...
    Reasoning {},
    /// Catch-all for output kinds MoeResearch does not currently understand. The
