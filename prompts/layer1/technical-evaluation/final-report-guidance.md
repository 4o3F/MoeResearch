...
2. Create an internal section plan mapping each section to recommendation/decision effect, evidence IDs, counterarguments, confidence, validation need, and Annex destination.
...
| Evidence closure | each load-bearing factual claim has evidence IDs/citekeys or is an explicit assumption/open question/abstention |
