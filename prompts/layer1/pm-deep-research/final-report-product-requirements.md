...
| 13-section narrative report 13 章 (v2.0/v2.1/v2.2) | 8-section PR-FAQ template 8 段 (本 profile v2.3) | 区别 |
|---|---|---|
...
| Ch 5 竞品图谱 | 8-section PR-FAQ template 无对应章 | PRD 前置物不做竞品图谱 (那是 v2.0 competitive) |
...
- Sentinels: see [`docs/specs/capabilities/product-requirements.md`](../../../docs/pm-deep-research/capabilities/product-requirements.md) §7.
