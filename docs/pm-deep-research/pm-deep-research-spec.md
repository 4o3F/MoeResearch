# PM DeepResearch 通用产品深度研究规格（通用层）
...
> 竞品研究的已验证方法论由本文件 + [`capabilities/competitive.md`](capabilities/competitive.md) 共同承载（黄金 [Strava](evaluation/golden/competitive-strava-coach-upgrade.md)）。
...
- 竞品研究的验证产物（[Strava 黄金](evaluation/golden/competitive-strava-coach-upgrade.md)，validated 2026-06-01）→ 通用规格的方法论承载来源。
- 4 能力黄金（competitive / product-capability / innovation-direction / product-requirements）见 [`evaluation/golden/`](evaluation/golden/) 索引。
