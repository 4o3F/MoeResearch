...
3. Pass the runtime-confirmed provider lists and Skill-internal `operator_limits` into `../prompts/layer1/technical-evaluation/task-decomposition.md`, then produce a `DeepResearchRequest` with only-tightened limits.
